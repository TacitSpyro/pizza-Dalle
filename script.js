...
card1.addEventListener("click", () => {
    imagem.src = "pizza_calabresa_e_mussarela_4389_orig.jpg";
...
card2.addEventListener("click", () => {
    imagem.src = "bife-e-cebola-caramelizada-com-queijo-suico-e-rucula-780x520.jpg";
...
card4.addEventListener("click", () => {
    imagem.src = "Pizza-de-calabresa-e-escarola.jpg";
...
card5.addEventListener("click", () => {
    imagem.src = "pizza-carbonara-com-bacon-74898136.webp";
...
card6.addEventListener("click", () => {
    imagem.src = "b762eabc40805110c7f70d63db021b39.jpg";
...
card7.addEventListener("click", () => {
    imagem.src = "vista-superior-de-pizza-com-pimenta-vermelha-e-ingredientes_23-2148765345.avif";
...
card8.addEventListener("click", () => {
    imagem.src = "swcs29ctxqcsnvabzknj.webp";
