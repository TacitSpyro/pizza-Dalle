...
card1.addEventListener("click", () => {
    imagem.src = "image_calabresa_001.png";
...
card2.addEventListener("click", () => {
    imagem.src = "image_costela_002.png";
...
card3.addEventListener("click", () => {
    imagem.src = "image_mussarella_003.png";
...
card4.addEventListener("click", () => {
    imagem.src = "image_escarola_004.png";
...
card5.addEventListener("click", () => {
    imagem.src = "image_carbonara_005.png";
...
card6.addEventListener("click", () => {
    imagem.src = "image_4queijos_006.png";
...
card7.addEventListener("click", () => {
    imagem.src = "image_chilli_007.png";
...
card8.addEventListener("click", () => {
    imagem.src = "image_carne_008.png";
